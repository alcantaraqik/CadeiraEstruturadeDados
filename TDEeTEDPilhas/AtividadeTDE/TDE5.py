...
class Aeroporto:
    ...
    def adicionar_lista_espera(self, aviao, identificacao_letra:str, identificacao_num:str):
    ...
    def caracteristicas_primeiro_aviao(self):
        if self.__pista_vazia():
            ...
            primeiro_aviao = self.identificacao_num[self.inicio]

            print(f"""PRÓXIMO AVIÃO A DECOLAR:{primeiro_aviao}
IDT LETRA: {letra_primeiro_aviao}
IDT NUM: {primeiro_aviao}\n""")

    def numero_avioes(self):
        if self.__pista_vazia():
            print("NAO HÁ AVIÕES NA FILA!!")
        else:
            print(f"A QUANTIDADE DE AVIÕES NA FILA É DE {self.numero_avioes}!!\n")
...
if __name__ == "__main__":
    a = Aeroporto(10)
    a.adicionar_lista_espera(1, "B", "1")
    a.adicionar_lista_espera(2, "C", "2")
    a.adicionar_lista_espera(3, "D", "3")
    a.adicionar_lista_espera(4, "E", "4")
    a.adicionar_lista_espera(5, "F", "5")
    a.adicionar_lista_espera(6, "G", "6")
    a.adicionar_lista_espera(7, "H", "7")
    a.adicionar_lista_espera(8, "I", "8")
    a.adicionar_lista_espera(9, "J", "9")
    a.adicionar_lista_espera(10, "K", "10")
